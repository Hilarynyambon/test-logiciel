...
public class RegisterPage extends Page{
    ...
    public  void singUp(){
        ...
        this.driver.findElement(email_lodgin).sendKeys("hilary@gmail5.com");
        this.driver.findElement(password).sendKeys("hilarydiane5");
        this.driver.findElement(confirme_password).sendKeys("hilarydiane5");
